...
"./programs/venc" -q10 audio.wav "./temp/audio_youtube.ogg"
...
mkvmerge.exe -o "./output/encode_youtube.mkv" --compression -1:none "./temp/video_youtube.mkv" "./temp/audio_youtube.ogg"